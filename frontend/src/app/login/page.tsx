    ...
    <div className="flex min-h-[70vh] items-center justify-center">
      <div className="w-full max-w-md rounded-[32px] border border-[#f4d3b2] bg-white p-8 shadow-[0_25px_80px_-50px_rgba(26,161,213,0.35)]">
        <div className="space-y-3">
          ...
          <p className="text-sm text-[#1b3f7a]/70">Acceso con invitación para mantener seguridad y confianza.</p>
        </div>
        ...
        <div className="mt-6">
          ...
          <label className="block mt-3 text-sm text-[#1b3f7a]">
            ...
            <input value={invite} onChange={e => setInvite(e.target.value)} className="mt-2 w-full rounded-2xl border border-[#f1d0ae] bg-[#fff6ec] px-4 py-3 text-sm text-[#12376c] outline-none ring-2 ring-transparent transition focus:ring-[#1aa1d5]/40" placeholder="INV-2026" type="text" />
          </label>
